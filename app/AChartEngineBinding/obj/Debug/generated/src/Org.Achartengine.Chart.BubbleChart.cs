...
namespace Org.Achartengine.Chart {
	...
	public partial class BubbleChart : global::Org.Achartengine.Chart.XYChart {
		...
		public unsafe BubbleChart (global::Org.Achartengine.Model.XYMultipleSeriesDataset p0, global::Org.Achartengine.Renderer.XYMultipleSeriesRenderer p1)
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.achartengine.chart']/class[@name='BubbleChart']/method[@name='clickableAreasForPoints' and count(parameter)=5 and parameter[1][@type='float[]'] and parameter[2][@type='double[]'] and parameter[3][@type='float'] and parameter[4][@type='int'] and parameter[5][@type='int']]"
