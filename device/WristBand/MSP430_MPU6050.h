...
void getIMUdata(int8_t* axh, int8_t* axl, int8_t* ayh, int8_t* ayl, int8_t* azh, int8_t* azl, int8_t* gxh, int8_t* gxl, int8_t* gyh, int8_t* gyl, int8_t* gzh, int8_t* gzl);			//<! Function that retrieves the IMU data
