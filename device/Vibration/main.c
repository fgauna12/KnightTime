...
P1OUT = 0x01;				//Turn LED off before connection is made
...
//__delay_cycles(1000); //Really weak
//__delay_cycles(10000); //Good vibrations
//__delay_cycles(50000);// Feels like a pulse
//__delay_cycles(20000); // Alright
//__delay_cycles(15000); // Alright
__delay_cycles(12000); // Alright
